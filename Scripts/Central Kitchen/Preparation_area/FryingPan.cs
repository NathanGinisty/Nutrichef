...
public class FryingPan : MonoBehaviourPun, IInteractive
{
    ...
    private void FinishAction(Aliment _aliment, int _transformationTime, bool instantiateViewID)
    {
        ...
        int ObjectCookedViewID = objectCooked.photonView.ViewID;
    ...
    void StartDisplay(bool _state, bool _user)
    {
        ...
        uiFryingPan.DisplayCanvas(_state);
        ...
        uiFryingPan.DisplaySpriteFood(alimentFood, _state);
    }
