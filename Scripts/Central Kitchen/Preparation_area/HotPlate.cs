...
public class HotPlate : MonoBehaviourPun, IInteractive
{
    ...
    {
        photonView.RPC("TakeFoodOnline", RpcTarget.Others);
    ...
    void StartDisplay(bool _state, bool _user)
    {
        ...
        uiHotPlate.DisplayCanvas(_state);
